...
export const RPC_NEW_TOKEN_ENDPOINT = retrieveEnvVariable('RPC_NEW_TOKEN_ENDPOINT', logger);
export const RPC_NEW_TOKEN_WEBSOCKET_ENDPOINT = retrieveEnvVariable('RPC_NEW_TOKEN_WEBSOCKET_ENDPOINT', logger);

export const RPC_TX_ENDPOINT = retrieveEnvVariable('RPC_NEW_TOKEN_ENDPOINT', logger);
export const RPC_TX_WEBSOCKET_ENDPOINT = retrieveEnvVariable('RPC_NEW_TOKEN_WEBSOCKET_ENDPOINT', logger);


//export const QUICKNODE_HTTP_URL = retrieveEnvVariable('QUICKNODE_HTTP_URL', logger);
//export const QUICKNODE_WSS_URL = retrieveEnvVariable('QUICKNODE_WSS_URL', logger);
export const RAYDIUM_PROGRAM_ID = new PublicKey(retrieveEnvVariable('RAYDIUM_PROGRAM_ID', logger));
export const QUOTE_TOKEN_MINT = new PublicKey(retrieveEnvVariable('QUOTE_TOKEN_MINT', logger));
...
export const USE_TG_FEED = retrieveEnvVariable('USE_TG_FEED', logger) === 'true';
